...
/**
 * Simplified map toolbar with drawing controls - matches left panel structure
 */
const MapToolbar: React.FC<MapToolbarProps> = ({
  ...
  return (
    <>
      {/* Collapsible Right Panel - using absolute positioning with width animation */}
      <div className={`absolute right-0 top-0 transition-all duration-300 ease-in-out z-40 overflow-hidden ${isCollapsed ? 'w-0' : 'w-60'}`}>
        <div className="w-60 bg-white shadow-lg border-l border-gray-300 flex flex-col">
          ...
          {/* Content sections */}
          <div className="max-h-[calc(100vh-60px)] overflow-y-auto discreet-scrollbar">
            ...
            <div className="bg-blue-50 border-2 border-blue-300 p-4">
              ...
              {openSections.drawingTools && <div className="flex flex-col gap-3 pt-3">
                <Button
            ...
            <div className="bg-green-50 border-2 border-green-300 p-4">
              ...
              {openSections.actions && <div className="flex flex-col gap-3 pt-3">
                <Button
                  variant="outline"
                  size="sm"
            ...
            <div className="bg-purple-50 border-2 border-purple-300 p-4">
              ...
              {openSections.tools && <div className="flex flex-col gap-3 pt-3">
                <Button
